...
import com.example.picture_puzzles.NotimeActivity;
...
public class TimeAdapter extends BaseAdapter {
    ...
    public TimeAdapter(NotimeActivity notimeactivity, List<String> arrayList, TextView countdown, ProgressBar progressBar) {
        this.notimeactivity = notimeactivity;
    ...
    {
        convertView = LayoutInflater.from(notimeactivity).inflate(R.layout.notime_item, parent, false);
        ImageView imageView = convertView.findViewById(R.id.gridimg);
        InputStream inputStream = null;
        try {
            inputStream = notimeactivity.getAssets().open("images/" + arrayList.get(position));
